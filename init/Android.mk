...
ifeq ($(TARGET_NO_SEPARATE_RECOVERY),true)
LOCAL_CFLAGS += -DNO_SEPARATE_RECOVERY
endif

ifeq ($(BOARD_CHARGING_CMDLINE_NEEDS_FS),true)
LOCAL_CFLAGS += -DBOARD_CHARGING_CMDLINE_NEEDS_FS
endif

SYSTEM_CORE_INIT_DEFINES := \
		BOARD_CHARGING_MODE_BOOTING_LPM \
		BOARD_CHARGING_CMDLINE_NAME \
		BOARD_CHARGING_CMDLINE_RECOVERY_VALUE \
